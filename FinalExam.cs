...
namespace Task07Test
{
    public class FinalExam : Exam
    {
        ...
        QuestionList QL;
        AnswerList AL;
        public FinalExam(string _n, int _t,int _m)
        {
            Name = _n;
            Time = _t;
            Mark = _m;
        ...
        public override void GenerateExam()
        {
            ...
            //string[] ra = new string[4];
            //ra[0] = "1";
            //ra[1] = "2";
            //ra[2] = "3";
            //ra[3] = "4";
            //ChooseAll test1 = new("Q2) What is OOP Main Priciples", "Choose All (space between answers)", answers2, ra);
            //test1.ShowQuestion();
            //string[] ranss;
            //string k;
            //Console.Write("Enter Your Answer : ");
            ...
            //    k = Console.ReadLine();
            //    ranss = k.Split(" ");
            //}while (ranss.Length > ra.Length) ;    
            //bool sa=false;
            //if (ranss.Length == ra.Length)
            //{
            //    for(int i=0;i<ranss.Length;i++)
            //        if (ranss[i] == ra[i])
            //        {
            //            sa = true;
            //        }
